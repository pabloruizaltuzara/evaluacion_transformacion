...
<div class="row">
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      ...
      <h4 class="card-title">Líderes</h4>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Registrar nuevo líder</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <select class="form-control form-control-sm" id="txtPuestoObrero">
            ...
            <option value="MAESTRANZA">LÍDER</option>
          </select>
        </div>

        <div class="form-group">
          <label for="txtMinisterio">Ministerio</label>
          <select class="form-control form-control-sm" id="txtMinisterio">
            <option value="">--Seleccionar--</option>
            <option value="SERVIDORES">SERVIDORES</option>
            <option value="DANZA/CORROS">DANZA/CORROS</option>
            <option value="ALABANZA">ALABANZA</option>
            <option value="JOVENES">JOVENES</option><option value="ALABANZA">ALABANZA</option>
            <option value="REDES Y MULTIMEDIA">REDES Y MULTIMEDIA</option>
