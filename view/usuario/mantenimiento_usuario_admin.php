  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <button type="button" class="btn btn-primary btn-icon-text" onclick="AbrirModalRegistroUsuario()">
          <i class="ti-user btn-icon-prepend"></i>
          Nuevo
        </button>

        <div class="table-responsive">
          <table class="table" id="usuario_admin">
            <thead>
              <tr>
                <th scope="col">#</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Registrar usuario administrador</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body">
        <input type="text" id="txtIdAdmin" hidden>

        <div class="form-group">
          <label>Nombre</label>
          <input type="text" name="img[]" class="file-upload-default">
          <div class="input-group col-xs-12">
            <input type="text" class="form-control file-upload-info" disabled placeholder="Nombre" id="txtNombreAdmin">
            <span class="input-group-append">
              <button class="file-upload-browse btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="AbrirModalRegistroUsuario2()">Elegir</button>
            </span>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="txtUsuarioAdmin" placeholder="Usuario">
        </div>
        <div class="form-group">
          <label for="txtPassAdmin">Contraseña</label>
          <input type="password" class="form-control" id="txtPassAdmin" placeholder="Contraseña">
        </div>
        <div class="form-group">
          <label for="txtPassAdminConfirm">Confirmar contraseña</label>
          <input type="password" class="form-control" id="txtPassAdminConfirm" placeholder="Confirmar contraseña">
        </div>

      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-light" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary" onclick="Registrar_Usuario_Admin()">Guardar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="seleccionaAdministrativo" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body" style="background-color: rgb(222,222,222);">
        <div class="table-responsive">
          <table class="table" id="administrativos_select">
            <thead>
              <tr>
                <th scope="col">#</th>
                <th scope="col">Foto</th>
